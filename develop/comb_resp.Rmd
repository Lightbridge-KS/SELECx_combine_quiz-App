...
tech_resp_df1_raw %>% combine_resp(sep_name = "-", split_cloze = F, sep_col = "a")
tech_resp_ls_raw %>% combine_resp(sep_col = ":")

combine_resp(int_nerv_resp)
combine_resp(tm_ncv_resp, extract_id_from = "Institution")

moodleQuiz::combine_resp(tech_resp_df1_raw, split_cloze = T)
```
...
ncv_po_resp_raw %>% combine_resp.data.frame(split_cloze = F)

tm_ncv_resp %>% combine_resp.data.frame(extract_id_from = "Institution",
                                        split_cloze = F)
```
