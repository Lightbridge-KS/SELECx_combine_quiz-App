### Embedded Answer (Cloze) Columns in Moodle Responses Report


# Automatic find & split Cloze colum in a DF ------------------------------
...
# Test if DF has any cloze column -----------------------------------------
